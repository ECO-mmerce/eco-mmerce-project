      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            {user_role === 'buyer' ? (
              <button
                className="flex items-center gap-3 text-xl bg-green-400 text-white px-5 py-2 rounded-lg my-2"
                onClick={handleChat}
              >
                <svg xmlns="http://www.w3.org/2000/svg" height="20" fill="currentColor" class="bi bi-chat-left-dots-fill" viewBox="0 0 16 16">
